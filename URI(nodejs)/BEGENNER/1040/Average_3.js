...
var average = parseFloat((N1 + N2 + N3 + N4) / 10);

console.log("Media: " + parseFloat((N1 + N2 + N3 + N4) / 10).toFixed(1));
if (average >= 7.0) {
  ...
  console.log("Nota do exame: " + linesF[1]);

  var lines2 = parseFloat(linesF[1]);
